...
export default function WeekdayCards({ weatherDaily, onDayClick, selectedTimestamp, timezone }: WeekdayCardsProps) {
  ...
  return (
    <div id="weather-timeline" className="flex relative space-x-2 min-w-max">
        ...
        return (
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className=" mt-1 h-8 text-wrap text-center text-xs w-full capitalize text-gray-400">{getWeatherDescription(day.weatherCode)}</div>
            </div>
